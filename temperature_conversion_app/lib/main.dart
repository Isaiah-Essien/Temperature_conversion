...
import 'package:temperature_conversion_app/image_and_text_strings.dart';
...
class _TemperatureConversionState extends State<TemperatureConversion> {
  ...
  void _convertTemperature() {
    ...
    if (_selectedConversion == 'F to C') {
      ...
      historyEntry =
          'F to C: ${input.toStringAsFixed(1)} => ${converted.toStringAsFixed(2)}';
    } else {
      converted = input * 9 / 5 + 32;
      historyEntry =
          'C to F: ${input.toStringAsFixed(1)} => ${converted.toStringAsFixed(2)}';
    }
  ...
  Widget _buildPortraitLayout() {
    return Column(
      children: [
        ...
        Center(
          child: Image(
            image: AssetImage(TempImages.tempImage1), // Replace with your image
          ...
          child: Column(
            children: [
              ...
              Center(
                child: Image(
                  image: AssetImage(
                      TempImages.tempImage1), // Replace with your image
